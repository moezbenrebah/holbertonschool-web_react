...
describe('Email Validation Tests', () => {
  test('submit button remains disabled with invalid email formats', async () => {
    const user = userEvent.setup();
    render(<Login />);
  ...
  test('submit button is enabled with valid email formats', async () => {
    const user = userEvent.setup();
    render(<Login />);
  ...
  test('submit button state changes from enabled to disabled when email becomes invalid', async () => {
    const user = userEvent.setup();
    render(<Login />);
