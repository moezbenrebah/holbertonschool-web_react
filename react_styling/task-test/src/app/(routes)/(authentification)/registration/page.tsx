		  ...
		  <div className="flex justify-between items-center mt-4">
			<div className="flex items-center">
			  ...
			  <label htmlFor="acceptTerms" className="ml-2 text-sm text-gray-900">
				J'accepte les <a href="/conditions-utilisation" target="_blank" rel="noopener noreferrer" className="text-amber-600 hover:text-amber-500">conditions d'utilisation</a>
			  </label>
			</div>
