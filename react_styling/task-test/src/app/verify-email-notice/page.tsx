            ...
            if (session?.user?.email) {
                try {
                    ...
                    if (data.verified) {
                        ...
                        setHasVerificationToken(data.hasVerificationToken);
                    }
                } catch (error) {
            ...
            <div className="max-w-md w-full space-y-8 p-8 bg-white rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 mb-6">
                    ...
                    {hasVerificationToken
                        ? " Un lien de vérification a déjà été envoyé à votre email. Veuillez consulter votre boîte de réception et cliquer sur le lien."
                        : " Veuillez demander un lien de vérification en cliquant sur le bouton ci-dessous."}
                </p>
                ...
                {requestStatus === 'idle' && (
                    ...
                    >
                        {hasVerificationToken ? "Renvoyer le lien de vérification" : "Envoyer un lien de vérification"}
                    </button>
                )}
