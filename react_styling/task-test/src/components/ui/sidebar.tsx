...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col  border-b border-sidebar-border border-gray-300 gap-2 p-2", className)}
      {...props}
    >
      <div className="flex flex-row gap-2 rounded-xl">
        {state === "collapsed" ? (
          // Logo icône quand fermé
          <h1 className="text-3xl font-light">
			<Image src="/logo.png" alt="logo" width={40} height={40}  className="rounded-lg"/>
          </h1>
        ) : (
          // Logo complet quand ouvert
          <Link href="/login">
            <h1 className="text-3xl font-light">
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-2 w-auto bg-sidebar-border bg-gray-300 border-b border-gray-300 hover:bg-amber-500", className)}
      {...props}
    />
  )
})
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md <p-4></p-4> text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
